...
@section('content')
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-4">
                                            ...
                                            <input class="form-control" type="text" name="email" id="email"
                                                value="{{ old('email') }} {{ $order->order_email }}"
                                                placeholder="E-mail">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" type="text" name="mobile_no" id="mobile_no"
                                                value=" {{ old('mobile_no') }} {{ $order->mobile_no }}"
                                        ...
                                        <div class="col-md-6 mb-4">
                                            ...
                                            <input class="form-control" id="state" name="state" type="text"
                                                value="{{ $order->state }}" placeholder="State">
                                            <span class="text-danger" id="state_error"></span>
                                        </div>
                                        <div class="col-md-6">
                                            <label>ZIP Code</label>
                                            <input class="form-control" id="zipcode" name="zipcode" type="text"
                                                value="{{ $order->zip_code }}" placeholder="ZIP Code">
    ...
    <button type="button" class="btn btn-danger btn-sm rounded-circle px-2"
        ...
        $(document).ready(function() {
            ...
            $('#poseditorderForm').on('submit', function(e) {
                e.preventDefault();
                ...
                if (!hasError) {
                    ...
                    let orderId = $('#order_id').val(); // make sure this exists


                    $.ajax({
                        url: '/admin/pos_edit_admin_cart/' + orderId,
                        method: "POST",
                        data: mydata,
                        processData: false,
                        contentType: false,
                        ...
                        success: function(response) {
                            Swal.fire({
                                icon: 'success',
                                title: 'Order Placed!',
                                text: 'Your order updated has been placed successfully.',
