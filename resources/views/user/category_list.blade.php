                        ...
                        <nav class="navbar bg-light">
                            <ul class="navbar-nav">
                                @foreach ($category as $cat)
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ url('category_list/' . $cat->id) }}">
                                            <i class="fa fa-tags"></i> {{ $cat->category_name }}
                                        </a>
                                    </li>
                                @endforeach
                            </ul>
                        ...
                        <nav class="navbar bg-light">
                            <ul class="navbar-nav">
                                @foreach ($subcategories as $sub)
                                    <li>
                                        <a href="{{ url('subcategory_list/' . $sub->id) }}">
                            ...
                            @foreach ($products as $product)
                                <div class="col-md-4">
                                    <div class="product-item">
                                        ...
                                        <div class="product-price">
                                            <h3><span>$</span>{{ $product->product_price }}</h3>
                                            <a class="" href="#"><i class="fa fa-shopping-cart"></i>Buy
                                                Now</a>
                                        </div>
                                    </div>
                                </div>
